...
<div class="col-md-10">
<a href="mailto:raza.hashim93@gmail.com" style="color:#000000">raza.hashim93@gmail.com</a><br /><br />
  ...
  <div class="modal-dialog">
    <div class="modal-content">
      <div class="modal-header">
        ...
        <h4 class="modal-title" style="font-family:'typo' "><span style="color:black">Developer</span></h4>
      </div>
      ...
      <div class="modal-body">
		...
		<div class="row">
		<div class="col-md-4">
		 <img src="image/hashimraza.jpg" width=100 height=100 alt="Hashim Raza" class="img-rounded">
		 </div>
		 <div class="col-md-5">
		<a href="http://mirzahashim.com" style="color:#202020; font-family:'typo' ; font-size:18px" title="Find on Facebook">Hashim Raza<>
		<h4 style="color:#202020; font-family:'typo' ;font-size:16px" class="title1">+917460088122</h4>
		<h4 style="font-family:'typo' ">raza.hashim93@gmail.com</h4>
